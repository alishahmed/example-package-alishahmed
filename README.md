...
`example-package-alishahmed` is a simple Python library that contains a single function for rescaling arrays.
...
```python
import numpy as np
from example_package_alishahmed.rescale import rescale
